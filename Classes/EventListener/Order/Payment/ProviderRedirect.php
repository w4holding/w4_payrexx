...
namespace W4Services\W4Payrexx\EventListener\Order\Payment;
...
use W4Services\W4Payrexx\Utility\Payrexx;
...
class ProviderRedirect
{
    ...
    public function __invoke(PaymentEvent $event): void
    {
        ...
        if ($this->orderItem->getPayment()->getProvider() !== 'payrexx') {
            return;
        }
     ...
     */
    private function storeAddressToSession(OrderItem $order): void
    {
